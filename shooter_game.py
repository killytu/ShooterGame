...
def show_go_screen():
    ...
    draw_text(screen, "SHUTER!", 64, WIDTH / 2, HEIGHT / 4)
...
shoot_sound = pygame.mixer.Sound(path.join(snd_dir, 'fire.ogg'))
shield_sound = pygame.mixer.Sound(path.join(snd_dir, 'powerup.ogg'))
power_sound = pygame.mixer.Sound(path.join(snd_dir, 'powerup.ogg'))
expl_sounds = []
for snd in ['expl3.ogg', 'expl6.ogg']:
